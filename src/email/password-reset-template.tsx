...
export const PasswordResetTemplate = ({ name, resetPasswordLink }: PasswordResetTemplateProps) => {
        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              Someone recently requested a password change for your Walletize account. If this was you, you can set a
              new password here:
            </Text>
